...
function burningCell(seed, x, y, columns, time, visibility = 1, amplitude = 1, sampleX = x) {
  ...
  const alpha = (hotEmber ? 0.2 + (noise - 0.52) * 0.62 : trail ? 0.06 + tailSignal * 0.16 : 0.12 + x / columns * 0.24 + noise * 0.12) * coverage;
